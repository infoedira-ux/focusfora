...
const SETBOOKS = [
  ...
  { id: "blossoms-savannah", title: "Blossoms of the Savannah", author: "Henry Ole Kulet", year: "2008", emoji: "🌸", category: "Novel", era: "2000s+" },
  { id: "river-source", title: "The River and the Source", author: "Margaret Ogola", year: "1994", emoji: "💧", category: "Novel", era: "90s-2000s" },
  { id: "samaritan", title: "The Samaritan", author: "John Lara", year: "2010s", emoji: "🤝", category: "Novel", era: "2000s+" },
  { id: "silent-song", title: "The Silent Song", author: "Various", year: "2010s", emoji: "🎵", category: "Novel", era: "2000s+" },
  { id: "whale-rider", title: "The Whale Rider", author: "Witi Ihimaera", year: "1987", emoji: "🐋", category: "Novel", era: "90s-2000s" },
  // Plays
  { id: "caucasian-chalk", title: "The Caucasian Chalk Circle", author: "Bertolt Brecht", year: "1944", emoji: "🎭", category: "Play", era: "60s-80s" },
  { id: "merchant-venice", title: "The Merchant of Venice", author: "William Shakespeare", year: "1600", emoji: "⚖️", category: "Play", era: "60s-80s" },
  { id: "betrayal-city", title: "Betrayal in the City", author: "Francis Imbuga", year: "1976", emoji: "🏙️", category: "Play", era: "60s-80s" },
  { id: "a-man-for-all", title: "A Man for All Seasons", author: "Robert Bolt", year: "1960", emoji: "👑", category: "Play", era: "60s-80s" },
  { id: "inheritance", title: "Inheritance", author: "David Mulwa", year: "2004", emoji: "🏛️", category: "Play", era: "2000s+" },
  { id: "parliament-owls", title: "Parliament of Owls", author: "Various", year: "2010s", emoji: "🦉", category: "Play", era: "2000s+" },
  // Short Stories
...
const ERAS = ["All Eras", "60s-80s", "90s-2000s", "2000s+"];
      ...
      <div className="px-6 md:px-12 py-10 max-w-5xl mx-auto">
        ...
        <div className="mt-12 bg-aubergine rounded-sm p-8">
          ...
          <div className="flex flex-wrap gap-2">
            {["The River Between", "Betrayal in the City", "Caucasian Chalk Circle", "The River and the Source", "Merchant of Venice"].map(t => (
